...
function getLangArr($language = '', $moduleName = 'Vtiger') {
    $args = func_get_args();
    $formattedString = call_user_func_array(array('Vtiger_Language_Handler', 'getModuleStringsFromFile'), $args);
    array_shift($args);
    array_shift($args);
    ...
    $strings = $formattedString['languageStrings'];

//    $first_val = array_shift($strings);
    uasort($strings, "strcmp");
