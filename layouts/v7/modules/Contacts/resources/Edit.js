...
var incMonth = moment(moment()).add(3, 'months').format('DD-MM-YYYY');
if($('#Contacts_editView_fieldName_support_end_date').val().length > 0) {
	$('#Contacts_editView_fieldName_support_end_date').val(incMonth);
}
