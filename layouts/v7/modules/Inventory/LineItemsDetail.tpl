...
{assign var=SERVICES value=$SERVICE_ARRAY}
                ...
                {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                    <tr>
                        ...
                        {/if}
                            ...
                            {if $LINE_ITEM_DETAIL["hdnProductId$INDEX"]==600 }
                             {if $PRODUCT_VIEWABLE}
                                ...
                                {if $COMMENT_VIEWABLE && !empty($LINE_ITEM_DETAIL["productName$INDEX"])}
                                    <div>
                                        <h5><strong>{decode_html($LINE_ITEM_DETAIL["comment$INDEX"])|nl2br}</strong></h5>
                                    </div>
                                {/if}
                            </td>
                                {/if}
                            ...
                            <td>
                                <div>
                                    {if $LINE_ITEM_DETAIL["productDeleted$INDEX"]}
                                        {$LINE_ITEM_DETAIL["productName$INDEX"]}
                                    {else}
                                        <h5><a class="fieldValue" href="index.php?module={$LINE_ITEM_DETAIL["entityType$INDEX"]}&view=Detail&record={$LINE_ITEM_DETAIL["hdnProductId$INDEX"]}" target="_blank"><!-- {$LINE_ITEM_DETAIL["hdnProductId$INDEX"]} -  -->{$LINE_ITEM_DETAIL["productName$INDEX"]}
                                        </a></h5>
                                        {/if}
                                </div>
                                {if $LINE_ITEM_DETAIL["productDeleted$INDEX"]}
                        ...
                        {if $MARGIN_VIEWABLE}
                        <td><div align = "right">{vtranslate($LINE_ITEM_DETAIL["margin$INDEX"], 'Validity')}</div></td>
                        {/if}
