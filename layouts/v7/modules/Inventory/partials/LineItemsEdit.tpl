	...
	{if $BLOCK_FIELDS|@count gt 0}
		<div class='fieldBlockContainer'>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;display: none;">
					<div style="float: right;">
						...
						<select class="select2 lineItemTax" id="taxtype" name="taxtype" style="width: 150px;">
							...
							<option selected value="group" {if $IS_GROUP_TAX_TYPE}selected{/if}>{vtranslate('LBL_GROUP', $MODULE)}</option>
						</select>
					</div>
				</div>
			</div>
