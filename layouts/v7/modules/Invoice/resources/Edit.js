...
if(GetURLParameter('relProject') !== undefined) {
	$('.editViewContents').append("<input type='hidden' name='relProject' value='"+ GetURLParameter('relProject') +"'>");
}

let format1 = $('#Invoice_editView_fieldName_duedate').data('date-format').toUpperCase();
let format2 = $('#Invoice_editView_fieldName_invoicedate').data('date-format').toUpperCase();

var incToday = moment().format(format1);
var incMonth = moment(moment()).add(30, 'days').format(format2);

if($('#Invoice_editView_fieldName_duedate').val().length <= 0) {
	$('#Invoice_editView_fieldName_duedate').val(incMonth);
}
if($('#Invoice_editView_fieldName_invoicedate').val().length <= 0) {
	$('#Invoice_editView_fieldName_invoicedate').val(incToday);
