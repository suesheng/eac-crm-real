...
jQuery.Class("PDFMaker_FreeActions_Js",{
    ...
    sendEmailPDF: function(pdflanguage, templateids) {

        var params = this.getDefaultParams('SendEmail',pdflanguage,templateids);
    ...
    getDefaultParams: function(viewtype,pdflanguage,templateids) {
    ...
    registerPDFPreviewActionsButtons: function (modalContainer,pdflanguage){
        ...
        modalContainer.find('.sendEmailWithPDF').on('click', function(e){
            app.helper.hideModal().then(function() {
                ...
                if( email_function == 'EMAILMaker') {
                    ...
                    let templateids = 4;
                    self.sendEmailPDF(pdflanguage, templateids);
                }
            });
        });
    },
