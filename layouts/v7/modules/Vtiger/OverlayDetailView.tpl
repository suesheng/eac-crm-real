    ...
    <div class = "modal-content">
        <div class="overlayDetailHeader col-lg-12 col-md-12 col-sm-12" style="z-index:1;">
            ...
            <div class = "col-lg-2 col-md-2 col-sm-2">
                <div class="clearfix">
                    <div class = "btn-group">
                        {*{php}var_dump($RECORD->getRawData()); exit;{/php}*}
                        <button class="btn btn-default fullDetailsButton" onclick="window.location.href = '{$RECORD->getFullDetailViewUrl()}&app={$SELECTED_MENU_CATEGORY}&relProject='+ GetURLParameter('record') +''">{vtranslate('LBL_DETAILS',$MODULE_NAME)}</button>
