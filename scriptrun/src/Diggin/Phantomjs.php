...
//        var_dump("cd $script && node index.js $argsString"); exit;

        return shell_exec("cd $script && node index.js $argsString");
    }
    ...
    public function getHtml($url)
    {
        ...
        $argsString = $url;
        $output = $this->execute('/var/www/html/NodeJsDomProd', $argsString);
        $content = $output;
