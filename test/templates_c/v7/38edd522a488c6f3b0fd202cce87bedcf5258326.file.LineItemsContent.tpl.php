<?php /* Smarty version Smarty-3.1.7, created on 2019-07-05 14:04:42
         compiled from "/var/www/html/eac-crm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11410576135cc1b72269c407-20379937%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38edd522a488c6f3b0fd202cce87bedcf5258326' => 
    array (
      0 => '/var/www/html/eac-crm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsContent.tpl',
      1 => 1562335445,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11410576135cc1b72269c407-20379937',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5cc1b7227870c',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
<?php if ($_valid && !is_callable('content_5cc1b7227870c')) {function content_5cc1b7227870c($_smarty_tpl) {?>
...
' height="42" width="42"></td><?php }?><?php if ($_smarty_tpl->tpl_vars['PRODUCT_EDITABLE']->value){?><td <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['productName']->value];?>
<?php $_tmp3=ob_get_clean();?><?php if ($_tmp3=='Product_Name'){?> class="product-prod" <?php }else{ ?> class="prod-service" <?php }?>><!-- Product Re-Ordering Feature Code Addition Starts --><input type="hidden" name="hidtax_row_no<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
...
</textarea></div><?php }?><?php }?></td><?php }?><?php if ($_smarty_tpl->tpl_vars['MARGIN_EDITABLE']->value&&$_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value){?><td><select name="<?php echo $_smarty_tpl->tpl_vars['margin']->value;?>
" id="service_validty" class="form-control"><?php  $_smarty_tpl->tpl_vars['validity'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['validity']->_loop = false;
 $_smarty_tpl->tpl_vars['val'] = new Smarty_Variable;
 $_from = getLangArr('','Validity'); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['validity']->key => $_smarty_tpl->tpl_vars['validity']->value){
$_smarty_tpl->tpl_vars['validity']->_loop = true;
 $_smarty_tpl->tpl_vars['val']->value = $_smarty_tpl->tpl_vars['validity']->key;
?><option <?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['margin']->value]==$_smarty_tpl->tpl_vars['val']->value){?>selected<?php }?> value="<?php echo strtolower($_smarty_tpl->tpl_vars['val']->value);?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['validity']->value,'Validity');?>
</option><?php } ?></select></td><?php }?><td><input id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" type="text" class="qty smallInputBox inputElement"data-rule-required=true data-rule-positive=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value];?>
<?php }else{ ?>0<?php }?>"<?php if ($_smarty_tpl->tpl_vars['QUANTITY_EDITABLE']->value==false){?> disabled=disabled <?php }?> /><?php if ($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value==false&&$_smarty_tpl->tpl_vars['MODULE']->value!='PurchaseOrder'){?><input id="<?php echo $_smarty_tpl->tpl_vars['purchaseCost']->value;?>
...
</span></span><?php }?></td><?php if ($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value||$_smarty_tpl->tpl_vars['MODULE']->value=='SalesOrder'){?><td><input name="<?php echo $_smarty_tpl->tpl_vars['purchaseCost']->value;?>
" type="text" value="<?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value];?>
...
<?php }else{ ?>0<?php }?></div></td><td><input type="hidden" name="netprice" value="<?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['netPrice']->value]){?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['netPrice']->value];?>
<?php }else{ ?>0<?php }?>"><span id="netPrice<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
