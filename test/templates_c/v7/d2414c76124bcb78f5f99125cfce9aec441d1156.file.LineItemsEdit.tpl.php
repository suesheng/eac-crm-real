<?php /* Smarty version Smarty-3.1.7, created on 2019-09-12 14:35:59
         compiled from "/var/www/html/eac-crm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13258297895cc1b72258e579-56829930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd2414c76124bcb78f5f99125cfce9aec441d1156' => 
    array (
      0 => '/var/www/html/eac-crm/includes/runtime/../../layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1568298949,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13258297895cc1b72258e579-56829930',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5cc1b722693f0',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'LINEITEM_FIELDS' => 0,
...
<?php if ($_valid && !is_callable('content_5cc1b722693f0')) {function content_5cc1b722693f0($_smarty_tpl) {?>
...
" id="prev_selected_currency_id" /><input type="hidden" id="default_currency_id" value="<?php echo $_smarty_tpl->tpl_vars['CURRENCIES']->value[0]['curid'];?>
" /><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['SELECTED_CURRENCY']->value['currency_id'];?>
" id="selectedCurrencyId" /></center></div><div class="col-lg-4 col-md-4 col-sm-4" style="top: 3px;display: none;"><div style="float: right;"><i class="fa fa-info-circle"></i>&nbsp;<label><?php echo vtranslate('LBL_TAX_MODE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label>&nbsp;<select class="select2 lineItemTax" id="taxtype" name="taxtype" style="width: 150px;"><option selected value="group" <?php if ($_smarty_tpl->tpl_vars['IS_GROUP_TAX_TYPE']->value){?>selected<?php }?>><?php echo vtranslate('LBL_GROUP',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></td><?php }?><?php if ($_smarty_tpl->tpl_vars['MARGIN_EDITABLE']->value&&$_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value){?><td><strong class="pull-right"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['margin']->get('label');?>
...
</strong></td><td><strong class="pull-right"><?php echo vtranslate('LBL_NET_PRICE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
